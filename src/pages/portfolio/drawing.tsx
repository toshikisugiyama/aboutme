...
const images: Array<ImageType> = [...Array(imageFiles)].map((_: undefined, i: number) => ({
  ...
  src: `https://raw.githubusercontent.com/toshikisugiyama/illustrator-works/master/drawing-${editNumberStyle(i+1)}/drawing-${editNumberStyle(i+1)}.svg`,
  url: `https://github.com/toshikisugiyama/illustrator-works/blob/master/drawing-${editNumberStyle(i+1)}/README.md`
}))
